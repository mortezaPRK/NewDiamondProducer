#ifndef SimPPS_PPSDiamondlDigiProducer_RDim_SignalPoint_H
#define SimPPS_PPSDiamondlDigiProducer_RDim_SignalPoint_H
...
public:
  ...
  RDimSignalPoint(double x, double y, double s, double charge) : pos_(x, y), sigma_(s), charge_(charge){};
